...
This package also depends on unregistered package [`ScaledPolynomials.jl`](https://github.com/Manarom/ScaledPolynomials.jl.git), which provides custom implementation of Bernstein basis polynomials (and some other) which is useful for constraint optimization of spectral emissivity.
  
  In `.//notebooks` folder there are two [Pluto](https://plutojl.org/) notebooks, which can be used as examples of package usage.
...
Pkg.add(url = "https://github.com/Manarom/BandPyrometry.jl.git") 
```
